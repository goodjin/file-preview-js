...
- [ ] 3. 实现按类型分组功能（组织功能）
  - [ ] 3.1 实现工件类型识别逻辑
    - [ ] 3.1.1 复用 ArtifactManager._isImageType() 判断图片类型
    - [ ] 3.1.2 实现其他类型识别（JSON、文本、HTML、代码等）
    - [ ] 3.1.3 建立类型到分组名称的映射
  - [ ] 3.2 实现分组显示逻辑
    - [ ] 3.2.1 将工件按类型分组
    - [ ] 3.2.2 为每个分组添加标题显示
    - [ ] 3.2.3 复用 ArtifactManager._getFileIconByType() 获取分组图标
  - [ ] 3.3 更新HTML结构和样式
    - [ ] 3.3.1 设计分组标题样式（图标+标题文字）
    - [ ] 3.3.2 调整工件链接在分组内的显示
