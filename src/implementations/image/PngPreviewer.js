/**
 * PNG格式预览器
 * @description 负责PNG格式图片的预览、缩放、旋转等操作
 */
 ...
 * PNG预览器类
 * @class PngPreviewer
 * @description PNG预览器与JPG预览器功能类似，但PNG支持透明度，需要特殊处理
 */
class PngPreviewer {
  /**
   * 构造函数
  ...
  async render(container) {
    ...
    // 创建包装器 - PNG需要棋盘格背景以显示透明度
    this.wrapper = document.createElement('div');
    this.wrapper.className = 'image-preview-wrapper png-preview';
